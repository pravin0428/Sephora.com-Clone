...
const [makeup , setMakeup] = useState([])
  useEffect(() =>{
  fetch(`https://database-pravin.herokuapp.com/fragrance`).then((res) => res.json())
  .then((res) =>{
    // console.log(res)
    setMakeup(res)
  }).catch((err)=>{
  ...
  return (
    ...
    <Box> <Image src="https://logan.nnnow.com/content/dam/nnnow-project/27-sep-2021/FragranceDesktop.jpg" alt="makeupmainImg" /> </Box>
    </Box>
    </Container>
